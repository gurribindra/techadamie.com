...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/css/intlTelInput.css">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="contact--info-area">
                            ...
                            <p>
                               We are listening! Get in touch, or leave your contact details.
                            </p>
                            ...
                            <div class="ab-social">
                                <h5>Follow Us</h5>
								@if(!empty($contacts->facebook_link))
                                <a class="fac" target="_blank" href="{{$contacts->facebook_link}}"><i class="social_facebook"></i></a>
								@endif

								@if(!empty($contacts->twitter_link))
                                <a class="twi" target="_blank" href="{{$contacts->twitter_link}}"><i class="social_twitter"></i></a>
								@endif

								@if(!empty($contacts->youtube_link))
                                <a class="you" target="_blank" href="{{$contacts->youtube_link}}"><i class="social_youtube"></i></a>
								@endif

								@if($contacts->linkedin_link)
                                <a class="lin" target="_blank" href="{{$contacts->linkedin_link}}"><i class="social_linkedin"></i></a>
								@endif
                            </div>
                        </div>
                    </div>
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="{{ route("contacts.store") }}" method="POST">
				@csrf
